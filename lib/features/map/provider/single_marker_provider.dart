...
final getMarkers = FutureProvider.autoDispose
    .family<MarkersModeData, Place>((ref, data) async {
  return await _setSingleMarker(data);
});

Future<MarkersModeData> _setSingleMarker(Place data) async {
  ...
  return MarkersModeData(
      ...
      customIcons: [BitmapDescriptor.fromBytes(markerIcon)],
      locations: [data]);
}
